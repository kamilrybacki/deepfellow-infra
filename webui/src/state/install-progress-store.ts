...
function shouldIgnoreProgressUpdate(
  prev: InstallProgress | undefined,
  next: InstallProgress | undefined,
): boolean {
...
export function setServiceInstallProgress(
  serviceId: string,
  progress: InstallProgress | undefined,
) {
...
export function setModelInstallProgress(
  serviceId: string,
  modelId: string,
  progress: InstallProgress | undefined,
) {
...
export function useModelInstallProgress(
  serviceId: string,
  modelId: string,
): InstallProgress | undefined {
  const key = modelKey(serviceId, modelId);
